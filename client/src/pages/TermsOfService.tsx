          ...
          <div className="space-y-10 mt-10">
            ...
            <section className="space-y-4">
              ...
              <GoldCard testId="card-pricing-structure">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  {[
                    { label: "Loyalty Cards Only", price: "€19" },
                    { label: "Spin Wheel Only", price: "€5" },
                    { label: "Menu Builder Only", price: "€8" },
                    { label: "Shift Manager Only", price: "€18" },
                    { label: "Complete Bundle", price: "€36.99", note: "All features included" },
                  ].map(item => (
