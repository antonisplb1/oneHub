...
-   **Landing Page Redesign (Comprehensive)**: Clean, professional landing page consolidating company information and product showcase. Features hero section with clear value proposition, four product cards (Loyalty Cards, Spin Wheel, Menu Builder, Shift Manager) with key features (no pricing), "Why uniHub.live?" section explaining product flexibility, Mission & Vision cards with icons, Who We Serve section (6 business types: Cafés, Restaurants, Bars, Bakeries, Salons, Retail), Why Businesses Choose uniHub section (6 benefits: Browser-Based, QR Setup, Modern Design, Affordable, Continuous Improvements, No Coding), trust indicators (Stripe, GDPR, cancel anytime), and comprehensive footer. Product cards use unified design matching the pricing page. All pricing information is on the dedicated `/pricing` page.
