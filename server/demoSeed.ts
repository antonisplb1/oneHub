  ...
  const menuData = [
    {
      ...
      items: [
        { name: "Espresso",           description: "Rich, bold single shot",                price: 250 },
        { name: "Americano",          description: "Espresso with hot water",               price: 300 },
        { name: "Flat White",         description: "Double espresso with microfoam milk",   price: 380 },
        { name: "Cappuccino",         description: "Equal parts espresso, milk, and foam",  price: 380 },
        { name: "Latte",              description: "Espresso with silky steamed milk",      price: 400 },
        { name: "Oat Milk Latte",     description: "Latte made with creamy oat milk",       price: 450 },
        { name: "Mocha",              description: "Chocolate espresso with steamed milk",  price: 420 },
        { name: "Cold Brew",          description: "Slow-steeped 12 hr, served over ice",   price: 450 },
        { name: "Matcha Latte",       description: "Ceremonial grade matcha, oat milk",     price: 450 },
        { name: "Hot Chocolate",      description: "Rich Belgian drinking chocolate",       price: 380 },
        { name: "Chai Latte",         description: "Spiced chai concentrate, steamed milk", price: 400 },
        { name: "Iced Americano",     description: "Double espresso over ice",              price: 350 },
      ],
    },
    {
      name: "Breakfast", order: 1,
      items: [
        { name: "Avocado Toast",          description: "Sourdough, smashed avocado, chilli flakes",   price: 850  },
        { name: "Full Irish",             description: "Bacon, egg, sausage, beans, black pudding",   price: 1300 },
        { name: "Eggs Benedict",          description: "Poached eggs, hollandaise on toasted muffin", price: 1150 },
        { name: "Granola Bowl",           description: "House granola, natural yogurt, seasonal berries", price: 750 },
        { name: "Buttermilk Pancakes",    description: "Stack of 3 with maple syrup & fresh berries", price: 950  },
        { name: "Smoked Salmon Bagel",    description: "Cream cheese, capers, dill, red onion",       price: 1100 },
        { name: "Shakshuka",              description: "Eggs poached in spiced tomato sauce, feta",   price: 1050 },
        { name: "Overnight Oats",         description: "Chia seeds, almond milk, fruit compote",      price: 650  },
      ],
    },
    {
      name: "Pastries & Bakes", order: 2,
      items: [
        { name: "Butter Croissant",   description: "Freshly baked, light and flaky",          price: 320 },
        { name: "Almond Croissant",   description: "Filled with almond frangipane",           price: 380 },
        { name: "Pain au Chocolat",   description: "Dark chocolate in a buttery pastry",      price: 350 },
        { name: "Blueberry Muffin",   description: "Bursting with fresh blueberries",         price: 320 },
        { name: "Carrot Cake Slice",  description: "Warming spices, cream cheese frosting",   price: 500 },
        { name: "Chocolate Brownie",  description: "Fudgy dark chocolate, sea salt top",      price: 400 },
        { name: "Banana Bread",       description: "Moist banana loaf, toasted with butter",  price: 350 },
        { name: "Cinnamon Roll",      description: "Soft dough, vanilla glaze",               price: 420 },
      ],
    },
    {
      name: "Lunch & Light Bites", order: 3,
      items: [
        { name: "Soup of the Day",       description: "Ask your barista for today's selection",  price: 650 },
        { name: "Caesar Salad",          description: "Romaine, parmesan, house dressing",       price: 900 },
        { name: "Grilled Chicken Wrap",  description: "Chicken, lettuce, tomato, chipotle mayo", price: 950 },
        { name: "Smashed Burger",        description: "Double smash, cheddar, pickles, sauce",   price: 1300 },
        { name: "Quiche of the Day",     description: "Homemade with seasonal filling",          price: 700 },
        { name: "Club Sandwich",         description: "Triple layer, chicken, bacon, egg",       price: 1050 },
      ],
    },
  ];
